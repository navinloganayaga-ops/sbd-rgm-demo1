...
# 1. Update Phase Indicators
phase_target = """    <div className="bg-white border border-slate-200 rounded-sm p-3 mb-4">
...
phase_replacement = """    <div className="bg-white border border-slate-200 rounded-sm p-3 mb-4">
...
content = content.replace(phase_target, phase_replacement)

# Now remove the Phase 2 components and fix Phase 1 buttons
