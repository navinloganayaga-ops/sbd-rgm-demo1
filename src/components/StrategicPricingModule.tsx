...
const mockSkus = [
  { id: '1', sku: 'DW-20V-091', desc: 'DeWalt 20V 3/8" Right Angle Drill', listPrice: 149.00, proposedIncrease: 10, newPrice: 163.90, cogsInc: 5, status: 'Base' },
  { id: '2', sku: 'ST-HT-882', desc: 'Stanley 16oz Fiberglass Hammer', listPrice: 24.50, proposedIncrease: 0, newPrice: 24.50, cogsInc: 0, status: 'Base' },
  { id: '3', sku: 'CM-V20-104', desc: 'Craftsman V20 Impact Driver', listPrice: 119.00, proposedIncrease: 15, newPrice: 136.85, cogsInc: 8, status: 'Base' },
  { id: '4', sku: 'DW-20V-MAX', desc: 'DeWalt 20V MAX 5.0Ah Battery', listPrice: 159.00, proposedIncrease: 5, newPrice: 166.95, cogsInc: 2, status: 'Base' },
];
                ...
                <table className="w-full text-left text-sm whitespace-nowrap">
                  <thead className="bg-white text-slate-500 font-bold border-b border-slate-200 text-xs uppercase tracking-wider">
                    <tr>
                      ...
                      <th className="p-4 text-center">COGS Change %</th>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white border border-slate-200 p-5 rounded shadow-sm flex flex-col">
                    <span className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Simulated GSV (Germany Level)</span>
